              ...
              >
                <a href="/" className="relative">
                  <Image
                    width={110}
                    height={80}
                    src="/images/txtli-logo/png/logo-no-background.png"
                    alt="Logo"
                ...
                <p className="mb-10 mt-5">
                  Txtli – The text-first CRM built for real estate wholesalers to automate follow-ups, manage leads, and close more deals.
                </p>
